...
export default function Navbar() {
  ...
  return (
    <div
      className={
        navbar
          ? "fixed w-full z-50 bg-white ease-in-out duration-300"
          : "fixed w-full z-50 ease-in-out duration-300"
      }
    >
          ...
          <ul className="flex justify-center pr-24 text-sm">
            ...
            >
              <span
                className={
                  pathName == "/"
                    ? "underline decoration-[#ec6169] decoration-4 underline-offset-8"
                    : ""
                }
              >
                <Link href="/">Home</Link>
